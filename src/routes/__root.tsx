  ...
  head: () => ({
    meta: [
      ...
      { title: "Atelier Partners — Furniture image portal" },
      {
        name: "description",
        content:
          "Partner portal for furniture brands: upload image packs, receive every catalogue format plus orthographic renders, and track approvals and monthly stats.",
      },
      { property: "og:title", content: "Atelier Partners — Furniture image portal" },
      {
        property: "og:description",
        content: "Upload furniture image packs and track approval status and monthly performance.",
      },
